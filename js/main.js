...
class Course {
    ...
    addStudent() {
        let name = prompt("Enter student full name:", "Stephen Johnson");
        let email = prompt("Enter student email:", "sjohnson@seattleu.edu");
    ...
    setTeacher() {
        let name = prompt("Enter full teacher name:", "John Doe");
